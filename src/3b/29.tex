...
\newcommand   \op          {\operatorname}
    ...
    We showed the existence of $f$ in the previous exercise by proving that $D$ is surjective.
...
\begin{align*}
        ...
        \begin{cases}
            3                \ &\text{for}\ k = 0 \\
            3z^k + 5kz^{k-1} \ &\text{for}\ k = 1,\dots,m .
        \end{cases}
\end{align*}
...
\begin{align*}
        f &= b_0g_0 + \dots + b_mg_m \\
          &= b_0(3) + b_1(3z+5) + \dots + b_m(3z^m + 5mz^{m-1}) \\
          &= 3b_0 + 3b_1z + 5b_1 + \dots + 3b_mz^m + 5mb_mz^{m-1} \\
