...
\end{align*}
    ...
    To recap, our steps so far have established a basis of $V$,
\begin{align*}
        u_1,\dots,u_m,v_1,\dots,v_n ,
\end{align*}
    where $u_1,\dots,u_m$ is a basis of $\op{null}S$ and $Sv_1,\dots,Sv_n$ is a basis of $\op{range}S$.

    Suppose $w_1,\dots,w_m$ is a basis of $\op{null}T$.

    For each $k=1,\dots,n$, since $Sv_k$ is an element of $\op{range}S$ and $\op{range}T = \op{range}S$, $Sv_k \in \op{range}T$.
    Hence there exists $x_k \in V$ such that
\begin{align*}
        Sv_k = Tx_k .
\end{align*}
    We will now show that $w_1,\dots,w_m,x_1,\dots,x_n$ is a basis of $V$ by showing that it is a linearly independent list of the right length.
...
\end{align*}
    ...
    Thus $w_1,\dots,w_m,x_1,\dots,x_n$ is a linearly independent list, which means it is a basis of $V$ because it is the right length.

    We are now ready to define $E \in \L(V)$ as a linear map such that
\begin{align*}
...
\end{align*}
    ...
    To see that $S=TE$, suppose $v \in V$.
...
\end{align*}
    %The $p_jSu_j$ terms disappeared because each $u_j \in \op{null}S$.

    Applying $TE$ to $v$,
\begin{align*}
        TEv &= TE(p_1u_1 + \dots + p_mu_m + q_1v_1 + \dots + q_nv_n) \\
            &= T(p_1Eu_1 + \dots + p_mEu_m + q_1Ev_1 + \dots + q_nEv_n) \\
            ...
            &= Sv .
\end{align*}
    %The $p_jTw_j$ terms disappeared because each $w_j \in \op{null}T$.
