...
\begin{align*}
        ...
        \end{cases}
\end{align*}
    To put this into words, we can turn the $k$th column of $A$ into the first column of $A$ by moving the $k$th entry to the top and dividing all other entries by $b$.

    Since this is true for any nonzero scalar $b$, we can reduce our cases to two:
\begin{align*}
        A_{j,k} &=
        \begin{cases}
            \ 0           &\text{for}\ j \neq k \\
